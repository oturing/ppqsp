...
descricao do item, preco unitario e quantidade.
    ...
    >>> bolas = ItemPedido(10, 'bola de golf', 2)
    >>> bolas.descr
    'bola de golf'
    >>> bolas.qtd
    10
...
O atributo qtd de um ItemPedido nunca pode ser <= 0:
    ...
    >>> duendes = ItemPedido(0, 'duende verde', 2.99)
    Traceback (most recent call last):
      ...
    TypeError: qtd deve ser > 0
    >>> duendes = ItemPedido(13, 'duende verde', 2.99)
    >>> duendes.qtd
    13
    >>> duendes.qtd = -1
    Traceback (most recent call last):
...
O preco também nao pode ser <= 0:
    ...
    >>> saci = ItemPedido(10, 'saci perere', -1)
    Traceback (most recent call last):
      ...
